...
open class ContainerBusFluidIO(private val part: PartFluidIO, player: EntityPlayer?) : Container() {
    ...
    init {
        for (i in 0..3)
            addSlotToContainer(SlotRespective(part.upgradeInventory, i, 187, i * 18 + 8))
        if (player != null) {
