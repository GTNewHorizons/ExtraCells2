...
public class MEVoidInventoryHandler<T extends IAEStack<T>> implements IMEInventoryHandler<T> {
    ...
    public MEVoidInventoryHandler(final IMEInventory<T> i, final StorageChannel channel) {
        if (i instanceof MEVoidInventoryHandler) {
            this.internal = (MEVoidInventoryHandler<T>) i;
        } else {
