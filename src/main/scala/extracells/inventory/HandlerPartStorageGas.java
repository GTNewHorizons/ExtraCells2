...
public class HandlerPartStorageGas extends HandlerPartStorageFluid {
    ...
    public boolean canAccept(IAEFluidStack input) {
        ...
        else return this.prioritizedFluids.isEmpty() || isPrioritized(input);
    }
    ...
    public boolean isPrioritized(IAEFluidStack input) {
        ...
        for (Fluid fluid : this.prioritizedFluids) if (fluid == input.getFluid()) return true;
        return false;
    }
    ...
    public void onNeighborChange() {
        ...
        this.externalHandler = ECApi.instance()
                .getHandler(tileEntity, this.node.getSide().getOpposite(), new MachineSource(this.node));
    }
