...
public class AdvancedCellInventory implements ICellInventory {
    ...
    private IStorageCellAdvanced cellType;

    private AdvancedCellInventory(final ItemStack o, final ISaveProvider container) throws AppEngException {
        if (itemSlots == null) {
        ...
        if (type instanceof IStorageCellAdvanced) {
            this.cellType = (IStorageCellAdvanced) this.cellItem.getItem();
    ...
    public static IMEInventoryHandler<IAEItemStack> getCell(final ItemStack o, final ISaveProvider container2) {
        try {
            return new AdvancedCellInventoryHandler(new AdvancedCellInventory(o, container2));
    ...
    private static boolean isStorageCell(final ItemStack itemStack) {
        ...
        try {
            ...
            if (type instanceof IStorageCellAdvanced) {
                return !((IStorageCellAdvanced) type).storableInStorageCell();
            }
    ...
    public static boolean isCell(final ItemStack itemStack) {
        ...
        if (type instanceof IStorageCellAdvanced) {
            return ((IStorageCellAdvanced) type).isStorageCell(itemStack);
        }
    ...
    public IAEItemStack injectItems(final IAEItemStack input, final Actionable mode, final BaseActionSource src) {
        ...
        if (AdvancedCellInventory.isStorageCell(sharedItemStack)) {
